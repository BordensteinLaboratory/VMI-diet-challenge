...
metacogy1ex = read_tsv("year1_sample_mapping_extended.txt") %>% 
  mutate(Ethnicity = case_when(
    Ethnicity == "African_American" ~ "Black", 
    Ethnicity == "Caucasian" ~ "White")) %>% 
  left_join(cogfy1, by = c("file_prefix" = "id")) %>% 
  filter(fecal_use == 1)
bray_fecal_cog_y1_ex = vegdist(metacogy1ex[,28:148], method = "bray")
adonis2(bray_fecal_cog_y1_ex ~ Ethnicity + `Study period` + antibiotics + contraception + subject_id, data = metacogy1ex, permutations = 4999)
cogoy1 = read_tsv("year1_files/cog.txt")
metacogoy1ex = read_tsv("year1_sample_mapping_extended.txt") %>% 
  mutate(Ethnicity = case_when(
    Ethnicity == "African_American" ~ "Black", 
    Ethnicity == "Caucasian" ~ "White")) %>% 
  left_join(cogfy1, by = c("file_prefix" = "id")) %>% 
  filter(oral_use == 1)
bray_oral_cog_y1_ex = vegdist(metacogoy1ex[,28:148], method = "bray")
adonis2(bray_oral_cog_y1_ex ~ Ethnicity + `Study period` + antibiotics + contraception + subject_id, data = metacogoy1ex, permutations = 4999)
...
adonis2(bray_fecalvcog_y1 ~ Ethnicity + Stage + antibiotics + contraception + Subject, data = vir_tax, permutations = 4999)
...
metaargy1ex = read_tsv("year1_sample_mapping_extended.txt") %>% 
  mutate(Ethnicity = case_when(
    Ethnicity == "African_American" ~ "Black", 
    Ethnicity == "Caucasian" ~ "White")) %>% 
  right_join(argfy1, by = c("file_prefix" = "sample")) %>% 
  filter(fecal_use == 1)
bray_fecal_arg_y1_ex = vegdist(metaargy1ex[,36:57], method = "bray")
adonis2(bray_fecal_arg_y1_ex ~ Ethnicity.x + `Study period` + antibiotics + contraception + subject_id, data = metaargy1ex, permutations = 4999)
jaccard_fecal_arg_y1_ex = vegdist(metaargy1ex[,36:57], method = "jaccard")
adonis2(jaccard_fecal_arg_y1_ex ~ Ethnicity.x + `Study period` + antibiotics + contraception + subject_id, data = metaargy1ex, permutations = 4999)
argoy1 = read_tsv("year1_files/args_noout.txt")
metaargoy1ex = read_tsv("year1_sample_mapping_extended.txt") %>% 
  mutate(Ethnicity = case_when(
    Ethnicity == "African_American" ~ "Black", 
    Ethnicity == "Caucasian" ~ "White")) %>% 
  right_join(argfy1, by = c("file_prefix" = "sample")) %>% 
  filter(oral_use == 1)
bray_oral_arg_y1_ex = vegdist(metaargoy1ex[,36:57], method = "bray")
adonis2(bray_oral_arg_y1_ex ~ Ethnicity.x + `Study period` + antibiotics + contraception + subject_id, data = metaargoy1ex, permutations = 4999)
jaccard_oral_arg_y1_ex = vegdist(metaargy1ex[,36:57], method = "jaccard")
adonis2(jaccard_oral_arg_y1_ex ~ Ethnicity.x + `Study period` + antibiotics + contraception + subject_id, data = metaargy1ex, permutations = 4999)
...
adonis2(bray_fecalvarg_y1 ~ Ethnicity + Stage + antibiotics + contraception + Subject, data = vir_arg, permutations = 4999)
...
metacazy1ex = read_tsv("year1_sample_mapping_extended.txt") %>% 
  mutate(Ethnicity = case_when(
    Ethnicity == "African_American" ~ "Black", 
    Ethnicity == "Caucasian" ~ "White")) %>% 
  right_join(cazfy1, by = c("file_prefix" = "sample")) %>% 
  filter(fecal_use == 1)
bray_fecal_caz_y1_ex = vegdist(metacazy1ex[,36:60], method = "bray")
adonis2(bray_fecal_caz_y1_ex ~ Ethnicity.x + `Study period` + antibiotics + contraception + subject_id, data = metacazy1ex, permutations = 4999)
jaccard_fecal_caz_y1_ex = vegdist(metacazy1ex[,36:60], method = "jaccard")
adonis2(jaccard_fecal_caz_y1_ex ~ Ethnicity.x + `Study period` + antibiotics + contraception + subject_id, data = metacazy1ex, permutations = 4999)

cazoy1 = read_tsv("year1_files/cazyme_noout.txt")
metacazoy1ex = read_tsv("year1_sample_mapping_extended.txt") %>% 
  mutate(Ethnicity = case_when(
    Ethnicity == "African_American" ~ "Black", 
    Ethnicity == "Caucasian" ~ "White")) %>% 
  right_join(cazfy1, by = c("file_prefix" = "sample")) %>% 
  filter(oral_use == 1)
bray_oral_caz_y1_ex = vegdist(metacazoy1ex[,36:60], method = "bray")
adonis2(bray_oral_caz_y1_ex ~ Ethnicity.x + `Study period` + antibiotics + contraception + subject_id, data = metacazoy1ex, permutations = 4999)
jaccard_oral_caz_y1_ex = vegdist(metacazoy1ex[,36:60], method = "jaccard")
adonis2(jaccard_oral_caz_y1_ex ~ Ethnicity.x + `Study period` + antibiotics + contraception + subject_id, data = metacazoy1ex, permutations = 4999)
...
adonis2(bray_fecalvcaz_y1 ~ Ethnicity + Stage + antibiotics + contraception + Subject, data = vir_caz, permutations = 4999)
