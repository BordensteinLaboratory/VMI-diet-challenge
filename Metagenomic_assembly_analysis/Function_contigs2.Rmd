...
jacc_cog_fecal = vegdist(relab_cog_fecal_filtered[,2:25], method = "jaccard", binary = T)
...
jacc_cog_oral = vegdist(relab_cog_oral_filtered[,2:25], method = "jaccard", binary = T)
...
jacc_cog_oral_black = vegdist(relab_cog_oral_filtered_black[,2:25], method = "jaccard", binary = T)
jacc_cog_oral_white = vegdist(relab_cog_oral_filtered_white[,2:25], method = "jaccard", binary = T)
...
anova(betadisper(bray_cog_fecal, group = relab_cog_fecal_filtered$Ethnicity))

anova(betadisper(bray_cog_fecal, group = relab_cog_fecal_filtered$`Study period`))

anova(betadisper(bray_cog_fecal, group = relab_cog_fecal_filtered$`Antibiotic use`))

anova(betadisper(bray_cog_fecal, group = relab_cog_fecal_filtered$`Contraceptive use`))

anova(betadisper(bray_cog_fecal, group = relab_cog_fecal_filtered$subject_id))
...
anova(betadisper(bray_cog_oral, group = relab_cog_oral_filtered$Ethnicity))

anova(betadisper(bray_cog_oral, group = relab_cog_oral_filtered$`Study period`))

anova(betadisper(bray_cog_oral, group = relab_cog_oral_filtered$`Antibiotic use`))

anova(betadisper(bray_cog_oral, group = relab_cog_oral_filtered$`Contraceptive use`))

anova(betadisper(bray_cog_oral, group = relab_cog_oral_filtered$subject_id))
...
#### Jaccard
Models with Jaccard distances were not run for COGs, as all COG categories appeared in all samples.
...
jacc_arg_fecal = vegdist(relab_arg_fecal_filtered[,2:22], method = "jaccard", binary = T)
...
jacc_arg_oral = vegdist(relab_arg_oral_filtered[,2:22], method = "jaccard", binary = T)
...
jacc_arg_oral_black = vegdist(relab_arg_oral_filtered_black[,2:22], method = "jaccard", binary = T)
jacc_arg_oral_white = vegdist(relab_arg_oral_filtered_white[,2:22], method = "jaccard", binary = T)
...
anova(betadisper(bray_arg_fecal, group = relab_arg_fecal_filtered$Ethnicity))

anova(betadisper(bray_arg_fecal, group = relab_arg_fecal_filtered$`Study period`))

anova(betadisper(bray_arg_fecal, group = relab_arg_fecal_filtered$`Antibiotic use`))

anova(betadisper(bray_arg_fecal, group = relab_arg_fecal_filtered$`Contraceptive use`))

anova(betadisper(bray_arg_fecal, group = relab_arg_fecal_filtered$subject_id))
...
anova(betadisper(bray_arg_oral, group = relab_arg_oral_filtered$Ethnicity))

anova(betadisper(bray_arg_oral, group = relab_arg_oral_filtered$`Study period`))

anova(betadisper(bray_arg_oral, group = relab_arg_oral_filtered$`Antibiotic use`))

anova(betadisper(bray_arg_oral, group = relab_arg_oral_filtered$`Contraceptive use`))

anova(betadisper(bray_arg_oral, group = relab_arg_oral_filtered$subject_id))
...
anova(betadisper(jacc_arg_fecal, group = relab_arg_fecal_filtered$Ethnicity))

anova(betadisper(jacc_arg_fecal, group = relab_arg_fecal_filtered$`Study period`))

anova(betadisper(jacc_arg_fecal, group = relab_arg_fecal_filtered$`Antibiotic use`))

anova(betadisper(jacc_arg_fecal, group = relab_arg_fecal_filtered$`Contraceptive use`))

anova(betadisper(jacc_arg_fecal, group = relab_arg_fecal_filtered$subject_id))
...
adonis2(jacc_arg_oral ~ subject_id + `Study period`, 
        data = relab_arg_oral_filtered, 
        permutations = 4999)
adonis2(jacc_arg_oral ~ Ethnicity + `Study period` + `Antibiotic use` + `Contraceptive use` + subject_id, data = relab_arg_oral_filtered, permutations = 4999)

anova(betadisper(jacc_arg_oral, group = relab_arg_oral_filtered$Ethnicity))

anova(betadisper(jacc_arg_oral, group = relab_arg_oral_filtered$`Study period`))

anova(betadisper(jacc_arg_oral, group = relab_arg_oral_filtered$`Antibiotic use`))

anova(betadisper(jacc_arg_oral, group = relab_arg_oral_filtered$`Contraceptive use`))

anova(betadisper(jacc_arg_oral, group = relab_arg_oral_filtered$subject_id))
...
jaccard_caz_fecal = vegdist(relab_caz_fecal_filtered[,2:26], method = "jaccard", binary = T)
jaccard_caz_oral = vegdist(relab_caz_oral_filtered[,2:26], method = "jaccard", binary = T)
...
anova(betadisper(bray_arg_fecal, group = relab_caz_fecal_filtered$Ethnicity))

anova(betadisper(bray_caz_fecal, group = relab_caz_fecal_filtered$`Study period`))

anova(betadisper(bray_caz_fecal, group = relab_caz_fecal_filtered$`Antibiotic use`))

anova(betadisper(bray_caz_fecal, group = relab_caz_fecal_filtered$`Contraceptive use`))

anova(betadisper(bray_caz_fecal, group = relab_caz_fecal_filtered$subject_id))
...
anova(betadisper(bray_caz_oral, group = relab_caz_oral_filtered$Ethnicity))

anova(betadisper(bray_caz_oral, group = relab_caz_oral_filtered$`Study period`))

anova(betadisper(bray_caz_oral, group = relab_caz_oral_filtered$`Antibiotic use`))

anova(betadisper(bray_caz_oral, group = relab_caz_oral_filtered$`Contraceptive use`))

anova(betadisper(bray_caz_oral, group = relab_caz_oral_filtered$subject_id))
...
anova(betadisper(jaccard_caz_fecal, group = relab_caz_fecal_filtered$Ethnicity))

anova(betadisper(jaccard_caz_fecal, group = relab_caz_fecal_filtered$`Study period`))

anova(betadisper(jaccard_caz_fecal, group = relab_caz_fecal_filtered$`Antibiotic use`))

anova(betadisper(jaccard_caz_fecal, group = relab_caz_fecal_filtered$`Contraceptive use`))

anova(betadisper(jaccard_caz_fecal, group = relab_caz_fecal_filtered$subject_id))
...
anova(betadisper(jaccard_caz_oral, group = relab_caz_oral_filtered$Ethnicity))

anova(betadisper(jaccard_caz_oral, group = relab_caz_oral_filtered$`Study period`))

anova(betadisper(jaccard_caz_oral, group = relab_caz_oral_filtered$`Antibiotic use`))

anova(betadisper(jaccard_caz_oral, group = relab_caz_oral_filtered$`Contraceptive use`))

anova(betadisper(jaccard_caz_oral, group = relab_caz_oral_filtered$subject_id))
```
...
metacogy1 = read_tsv("tables/year1_sample_mapping_extended.txt") %>%
...
bray_fecal_cog_y1 = vegdist(metacogy1[,28:52], method = "bray")

adonis2(bray_fecal_cog_y1 ~ Ethnicity + `Study period` + antibiotics + contraception + subject_id, data = metacogy1, permutations = 4999)

anova(betadisper(bray_fecal_cog_y1, group = metacogy1$Ethnicity))

anova(betadisper(bray_fecal_cog_y1, group = metacogy1$`Study period`))

anova(betadisper(bray_fecal_cog_y1, group = metacogy1$antibiotics))

anova(betadisper(bray_fecal_cog_y1, group = metacogy1$contraception))

anova(betadisper(bray_fecal_cog_y1, group = metacogy1$subject_id))

metacogy1_no20 = metacogy1 %>%
  filter(subject_id != "mb20")

bray_fecal_cog_y1_no20 = vegdist(metacogy1_no20[,28:52], method = "bray")

adonis2(bray_fecal_cog_y1_no20 ~ Ethnicity + `Study period` + antibiotics + contraception + subject_id, data = metacogy1_no20, permutations = 4999)

anova(betadisper(bray_fecal_cog_y1_no20, group = metacogy1_no20$Ethnicity))

anova(betadisper(bray_fecal_cog_y1_no20, group = metacogy1_no20$`Study period`))

anova(betadisper(bray_fecal_cog_y1_no20, group = metacogy1_no20$antibiotics))

anova(betadisper(bray_fecal_cog_y1_no20, group = metacogy1_no20$contraception))

anova(betadisper(bray_fecal_cog_y1_no20, group = metacogy1_no20$subject_id))
...
metacogoy1 = read_tsv("tables/year1_sample_mapping_extended.txt") %>% 
  mutate(Ethnicity = case_when(
    Ethnicity == "African_American" ~ "Black", 
    Ethnicity == "Caucasian" ~ "White")) %>% 
...
bray_oral_cog_y1 = vegdist(metacogoy1[,28:148], method = "bray")

adonis2(bray_oral_cog_y1 ~ Ethnicity + `Study period` + antibiotics + contraception + subject_id, data = metacogoy1, permutations = 4999)

anova(betadisper(bray_oral_cog_y1, group = metacogoy1$Ethnicity))

anova(betadisper(bray_oral_cog_y1, group = metacogoy1$`Study period`))

anova(betadisper(bray_oral_cog_y1, group = metacogoy1$antibiotics))

anova(betadisper(bray_oral_cog_y1, group = metacogoy1$contraception))

anova(betadisper(bray_oral_cog_y1, group = metacogoy1$subject_id))

metacogoy1_no20 = metacogoy1 %>%
  filter(subject_id != "mb20")

bray_oral_cog_y1_no20 = vegdist(metacogoy1_no20[,28:148], method = "bray")

adonis2(bray_oral_cog_y1_no20 ~ Ethnicity + `Study period` + antibiotics + contraception + subject_id, data = metacogoy1_no20, permutations = 4999)

anova(betadisper(bray_oral_cog_y1_no20, group = metacogoy1_no20$Ethnicity))

anova(betadisper(bray_oral_cog_y1_no20, group = metacogoy1_no20$`Study period`))

anova(betadisper(bray_oral_cog_y1_no20, group = metacogoy1_no20$antibiotics))

anova(betadisper(bray_oral_cog_y1_no20, group = metacogoy1_no20$contraception))

anova(betadisper(bray_oral_cog_y1_no20, group = metacogoy1_no20$subject_id))
...
metaargy1 = read_tsv("tables/year1_sample_mapping_extended.txt") %>% 
  mutate(Ethnicity = case_when(
    Ethnicity == "African_American" ~ "Black", 
    Ethnicity == "Caucasian" ~ "White")) %>% 
...
bray_fecal_arg_y1 = vegdist(metaargy1[,36:57], method = "bray")

adonis2(bray_fecal_arg_y1 ~ Ethnicity + `Study period` + antibiotics + contraception + Subject, data = metaargy1, permutations = 4999)

anova(betadisper(bray_fecal_arg_y1, group = metaargy1$Ethnicity.y))

anova(betadisper(bray_fecal_arg_y1, group = metaargy1$`Study period`))

anova(betadisper(bray_fecal_arg_y1, group = metaargy1$antibiotics))

anova(betadisper(bray_fecal_arg_y1, group = metaargy1$contraception))

anova(betadisper(bray_fecal_arg_y1, group = metaargy1$Subject))

metaargy1_no20 = metaargy1 %>%
  filter(subject_id != "mb20")

bray_fecal_arg_y1_no20 = vegdist(metaargy1_no20[,36:57], method = "bray")

adonis2(bray_fecal_arg_y1_no20 ~ Ethnicity + `Study period` + antibiotics + contraception + Subject, data = metaargy1_no20, permutations = 4999)

anova(betadisper(bray_fecal_arg_y1_no20, group = metaargy1_no20$Ethnicity.y))

anova(betadisper(bray_fecal_arg_y1_no20, group = metaargy1_no20$`Study period`))

anova(betadisper(bray_fecal_arg_y1_no20, group = metaargy1_no20$antibiotics))

anova(betadisper(bray_fecal_arg_y1_no20, group = metaargy1_no20$contraception))

anova(betadisper(bray_fecal_arg_y1_no20, group = metaargy1_no20$Subject))

jacc_fecal_arg_y1 = vegdist(metaargy1[,36:57], method = "jaccard", binary = T)

adonis2(jacc_fecal_arg_y1 ~ Ethnicity.y + `Study period` + antibiotics + contraception + Subject, data = metaargy1, permutations = 4999)

anova(betadisper(jacc_fecal_arg_y1, group = metaargy1$Ethnicity.y))

anova(betadisper(jacc_fecal_arg_y1, group = metaargy1$`Study period`))

anova(betadisper(jacc_fecal_arg_y1, group = metaargy1$antibiotics))

anova(betadisper(jacc_fecal_arg_y1, group = metaargy1$contraception))

anova(betadisper(jacc_fecal_arg_y1, group = metaargy1$Subject))

metaargy1_no20 = metaargy1 %>%
  filter(subject_id != "mb20")

jacc_fecal_arg_y1_no20 = vegdist(metaargy1_no20[,36:57], method = "jaccard", binary = T)

adonis2(jacc_fecal_arg_y1_no20 ~ Ethnicity.y + `Study period` + antibiotics + contraception + Subject, data = metaargy1_no20, permutations = 4999)

anova(betadisper(jacc_fecal_arg_y1_no20, group = metaargy1_no20$Ethnicity.y))

anova(betadisper(jacc_fecal_arg_y1_no20, group = metaargy1_no20$`Study period`))

anova(betadisper(jacc_fecal_arg_y1_no20, group = metaargy1_no20$antibiotics))

anova(betadisper(jacc_fecal_arg_y1_no20, group = metaargy1_no20$contraception))

anova(betadisper(jacc_fecal_arg_y1_no20, group = metaargy1_no20$Subject))
...
metaargoy1 = read_tsv("tables/year1_sample_mapping_extended.txt") %>% 
  mutate(Ethnicity = case_when(
    Ethnicity == "African_American" ~ "Black", 
    Ethnicity == "Caucasian" ~ "White")) %>% 
...
bray_oral_arg_y1 = vegdist(metaargoy1[,36:57], method = "bray")

adonis2(bray_oral_arg_y1 ~ Ethnicity + `Study period` + antibiotics + contraception + Subject, data = metaargoy1, permutations = 4999)

anova(betadisper(bray_oral_arg_y1, group = metaargoy1$Ethnicity.y))

anova(betadisper(bray_oral_arg_y1, group = metaargoy1$`Study period`))

anova(betadisper(bray_oral_arg_y1, group = metaargoy1$antibiotics))

anova(betadisper(bray_oral_arg_y1, group = metaargoy1$contraception))

anova(betadisper(bray_oral_arg_y1, group = metaargoy1$Subject))

metaargoy1_no20 = metaargoy1 %>%
  filter(subject_id != "mb20")

bray_oral_arg_y1_no20 = vegdist(metaargoy1_no20[,36:57], method = "bray")

adonis2(bray_oral_arg_y1_no20 ~ Ethnicity + `Study period` + antibiotics + contraception + Subject, data = metaargoy1_no20, permutations = 4999)

anova(betadisper(bray_oral_arg_y1_no20, group = metaargoy1_no20$Ethnicity.y))

anova(betadisper(bray_oral_arg_y1_no20, group = metaargoy1_no20$`Study period`))

anova(betadisper(bray_oral_arg_y1_no20, group = metaargoy1_no20$antibiotics))

anova(betadisper(bray_oral_arg_y1_no20, group = metaargoy1_no20$contraception))

anova(betadisper(bray_oral_arg_y1_no20, group = metaargoy1_no20$Subject))

jacc_oral_arg_y1 = vegdist(metaargoy1[,36:57], method = "jaccard", binary = T)

adonis2(jacc_oral_arg_y1 ~ Ethnicity.y + `Study period` + antibiotics + contraception + Subject, data = metaargoy1, permutations = 4999)

anova(betadisper(jacc_oral_arg_y1, group = metaargoy1$Ethnicity.y))

anova(betadisper(jacc_oral_arg_y1, group = metaargoy1$`Study period`))

anova(betadisper(jacc_oral_arg_y1, group = metaargoy1$antibiotics))

anova(betadisper(jacc_oral_arg_y1, group = metaargoy1$contraception))

anova(betadisper(jacc_oral_arg_y1, group = metaargoy1$Subject))

metaargoy1_no20 = metaargoy1 %>%
  filter(subject_id != "mb20")

jacc_oral_arg_y1_no20 = vegdist(metaargoy1_no20[,36:57], method = "jaccard", binary = T)

adonis2(jacc_oral_arg_y1_no20 ~ Ethnicity.y + `Study period` + antibiotics + contraception + Subject, data = metaargoy1_no20, permutations = 4999)

anova(betadisper(jacc_oral_arg_y1_no20, group = metaargoy1_no20$Ethnicity.y))

anova(betadisper(jacc_oral_arg_y1_no20, group = metaargoy1_no20$`Study period`))

anova(betadisper(jacc_oral_arg_y1_no20, group = metaargoy1_no20$antibiotics))

anova(betadisper(jacc_oral_arg_y1_no20, group = metaargoy1_no20$contraception))

anova(betadisper(jacc_oral_arg_y1_no20, group = metaargoy1_no20$Subject))
...
metafcazy1 = read_tsv("tables/year1_sample_mapping_extended.txt") %>% 
  mutate(Ethnicity = case_when(
    Ethnicity == "African_American" ~ "Black", 
    Ethnicity == "Caucasian" ~ "White")) %>% 
...
bray_fecal_caz_y1 = vegdist(metafcazy1[,36:60], method = "bray")

adonis2(bray_fecal_caz_y1 ~ Ethnicity + `Study period` + `Antibiotic use` + `Contraceptive use` + subject_id, data = metafcazy1, permutations = 4999)
anova(betadisper(bray_fecal_caz_y1, group = metafcazy1$Ethnicity.y))

anova(betadisper(bray_fecal_caz_y1, group = metafcazy1$`Study period`))

anova(betadisper(bray_fecal_caz_y1, group = metafcazy1$antibiotics))

anova(betadisper(bray_fecal_caz_y1, group = metafcazy1$contraception))

anova(betadisper(bray_fecal_caz_y1, group = metafcazy1$Subject))

metafcazy1_no20 = metafcazy1 %>%
  filter(subject_id != "mb20")

bray_fecal_caz_y1_no20 = vegdist(metafcazy1_no20[,36:60], method = "bray")

adonis2(bray_fecal_caz_y1_no20 ~ Ethnicity + `Study period` + antibiotics + contraception + Subject, data = metafcazy1_no20, permutations = 4999)

anova(betadisper(bray_fecal_caz_y1_no20, group = metafcazy1_no20$Ethnicity.y))

anova(betadisper(bray_fecal_caz_y1_no20, group = metafcazy1_no20$`Study period`))

anova(betadisper(bray_fecal_caz_y1_no20, group = metafcazy1_no20$antibiotics))

anova(betadisper(bray_fecal_caz_y1_no20, group = metafcazy1_no20$contraception))

anova(betadisper(bray_fecal_caz_y1_no20, group = metafcazy1_no20$Subject))

jacc_fecal_caz_y1 = vegdist(metafcazy1[,36:60], method = "jaccard", binary = T)

adonis2(jacc_fecal_caz_y1 ~ Ethnicity.y + `Study period` + antibiotics + contraception + Subject, data = metafcazy1, permutations = 4999)

anova(betadisper(jacc_fecal_caz_y1, group = metafcazy1$Ethnicity.y))

anova(betadisper(jacc_fecal_caz_y1, group = metafcazy1$`Study period`))

anova(betadisper(jacc_fecal_caz_y1, group = metafcazy1$antibiotics))

anova(betadisper(jacc_fecal_caz_y1, group = metafcazy1$contraception))

anova(betadisper(jacc_fecal_caz_y1, group = metafcazy1$Subject))

metafcazy1_no20 = metafcazy1 %>%
  filter(subject_id != "mb20")

jacc_fecal_caz_y1_no20 = vegdist(metafcazy1_no20[,36:60], method = "jaccard", binary = T)

adonis2(jacc_fecal_caz_y1_no20 ~ Ethnicity.y + `Study period` + antibiotics + contraception + Subject, data = metafcazy1_no20, permutations = 4999)

anova(betadisper(jacc_fecal_caz_y1_no20, group = metafcazy1_no20$Ethnicity.y))

anova(betadisper(jacc_fecal_caz_y1_no20, group = metafcazy1_no20$`Study period`))

anova(betadisper(jacc_fecal_caz_y1_no20, group = metafcazy1_no20$antibiotics))

anova(betadisper(jacc_fecal_caz_y1_no20, group = metafcazy1_no20$contraception))

anova(betadisper(jacc_fecal_caz_y1_no20, group = metafcazy1_no20$Subject))
...
metaocazy1 = read_tsv("tables/year1_sample_mapping_extended.txt") %>% 
  mutate(Ethnicity = case_when(
    Ethnicity == "African_American" ~ "Black", 
    Ethnicity == "Caucasian" ~ "White")) %>% 
...
bray_oral_caz_y1 = vegdist(metaocazy1[,36:60], method = "bray")

adonis2(bray_oral_caz_y1 ~ Ethnicity + `Study period` + `Antibiotic use` + `Contraceptive use` + subject_id, data = metaocazy1, permutations = 4999)
anova(betadisper(bray_oral_caz_y1, group = metaocazy1$Ethnicity.y))

anova(betadisper(bray_oral_caz_y1, group = metaocazy1$`Study period`))

anova(betadisper(bray_oral_caz_y1, group = metaocazy1$antibiotics))

anova(betadisper(bray_oral_caz_y1, group = metaocazy1$contraception))

anova(betadisper(bray_oral_caz_y1, group = metaocazy1$Subject))

metaocazy1_no20 = metaocazy1 %>%
  filter(subject_id != "mb20")

bray_oral_caz_y1_no20 = vegdist(metaocazy1_no20[,36:60], method = "bray")

adonis2(bray_oral_caz_y1_no20 ~ Ethnicity + `Study period` + antibiotics + contraception + Subject, data = metaocazy1_no20, permutations = 4999)

anova(betadisper(bray_oral_caz_y1_no20, group = metaocazy1_no20$Ethnicity.y))

anova(betadisper(bray_oral_caz_y1_no20, group = metaocazy1_no20$`Study period`))

anova(betadisper(bray_oral_caz_y1_no20, group = metaocazy1_no20$antibiotics))

anova(betadisper(bray_oral_caz_y1_no20, group = metaocazy1_no20$contraception))

anova(betadisper(bray_oral_caz_y1_no20, group = metaocazy1_no20$Subject))

jacc_oral_caz_y1 = vegdist(metaocazy1[,36:60], method = "jaccard", binary = T)

adonis2(jacc_oral_caz_y1 ~ Ethnicity.y + `Study period` + antibiotics + contraception + Subject, data = metaocazy1, permutations = 4999)

anova(betadisper(jacc_oral_caz_y1, group = metaocazy1$Ethnicity.y))

anova(betadisper(jacc_oral_caz_y1, group = metaocazy1$`Study period`))

anova(betadisper(jacc_oral_caz_y1, group = metaocazy1$antibiotics))

anova(betadisper(jacc_oral_caz_y1, group = metaocazy1$contraception))

anova(betadisper(jacc_oral_caz_y1, group = metaocazy1$Subject))

metaocazy1_no20 = metaocazy1 %>%
  filter(subject_id != "mb20")

jacc_oral_caz_y1_no20 = vegdist(metaocazy1_no20[,36:60], method = "jaccard", binary = T)
...
col3 = plot_grid(brayfargy1, brayoargy1, brayfvargy1,
                 ...
                 labels = c("c", "g", "k", "o", "s"), 
                 label_size = 20)
col4 = plot_grid(brayfcazy1, brayocazy1, brayfvcazy1,
...
```{r figure_s4}
svg(file = "figures/figure_S4.svg", width = 16, height = 20)
