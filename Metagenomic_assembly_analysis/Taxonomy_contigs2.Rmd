...
rel_abund_tax_fecal = rel_abund_tax_t %>% 
  filter(fecal_use == 1) 
write.csv(rel_abund_tax_fecal, "relative_abundance_values_fecal.csv")
...
rel_abund_tax_oral = rel_abund_tax_t %>% 
  filter(oral_use == 1)
write.csv(rel_abund_tax_oral, "relative_abundance_values_oral.csv")
...
jacc_oral = vegdist(relab_oral_filtered[,2:8063], method = "jaccard")
...
```{r nmds_y1ftax}
y1tax_ex = read_tsv("taxon_meta_y1_extended.txt")
...
jaccard_fecal_y1_ex = vegdist(y1taxfecal_ex[,9:9379], method = "jaccard")
jaccard_oral_y1_ex = vegdist(y1taxoral_ex[,9:9379], method = "jaccard")
jaccard_fecal_y1_ex_no20 = vegdist(y1taxfecal_ex_no20[,9:9379], method = "jaccard")
jaccard_oral_y1_ex_no20 = vegdist(y1taxoral_ex_no20[,9:9379], method = "jaccard")
...
jacc_fecal_y1 = vegdist(y1taxfecal, method = "jaccard")
...
jacc_fecal_y2 = vegdist(relab_fecal_filtered[,2:9266], method = "jacc")
...
jacc_oral_y1 = vegdist(y1taxoral, method = "jacc")
...
jacc_oral_y2 = vegdist(relab_oral_filtered[,2:8063], method = "jacc")
...
jacc_fecalv_y1 = vegdist(vir_tax[,7:4432], method = "jacc")
