...
tiff(file = "figures/nmds_plot_cog_bray.tif", res = 150, width = 18, 
     height = 7, units = "in")
...
mds_jacc_f_gene<-metaMDS(jaccf_gene, k=2, trymax=999, distance = "jaccard")
...
tiff(file = "figures/nmds_plot_cog_jacc.tif", res = 150, width = 18, 
     height = 7, units = "in")
...
tiff(file = "figures/nmds_plot_path_bray.tif", res = 150, width = 18, 
     height = 7, units = "in")
...
tiff(file = "figures/nmds_plot_path_jacc.tif", res = 150, width = 18, 
     height = 7, units = "in")
