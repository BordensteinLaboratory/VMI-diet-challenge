...
metadata_gene = read_tsv("year1_sample_mapping_genes_noout.tsv") %>% 
  mutate(Ethnicity = case_when(Ethnicity == "African_American" ~ "Black", 
                               Ethnicity == "Caucasian" ~ "White"))
```

Import normalized, unstratified gene abundance table with outliers (2f4, 4f2, 4f3, 4f4, 11f5) removed. Transpose.
```{r import_gene, error=FALSE}
gene_table = read_tsv("year1_genefamilies_cog_cpm_unstratified.tsv")
genes = gene_table %>% gather(file, count, 2:193) %>% 
...
genes_fecal_filtered = genes_fecal %>% 
  mutate(total = rowSums(genes_fecal[,2:57835])) %>% 
  filter(total > 0) %>% 
  select_if(~ !is.numeric(.) || sum(.) != 0) 
write_csv(genes_fecal_filtered, "gene_family_cog_cpm_fecal_year1.csv")
genes_fecal_filtered = read_csv("gene_family_cog_cpm_fecal_year1.csv")

genes_oral = genes %>% left_join(metadata_gene, by = "file") %>% 
  filter(oral_use == 1)
genes_oral_filtered = genes_oral %>% 
  mutate(total = rowSums(genes_oral[,2:57835])) %>% 
  filter(total > 0) %>% 
  select_if(~ !is.numeric(.) || sum(.) != 0) 
write_csv(genes_oral, "gene_family_cog_cpm_oral_year1.csv")
genes_oral_filtered = read_csv("gene_family_cog_cpm_oral_year1.csv")
```
...
brayf_gene = vegdist(genes_fecal_filtered[,2:42254], method = "bray")
jaccf_gene = vegdist(genes_fecal_filtered[,2:42254], method = "jaccard")
brayo_gene = vegdist(genes_oral_filtered[,2:33457], method = "bray")
jacco_gene = vegdist(genes_oral_filtered[,2:33457], method = "jaccard")
...
brayf_gene_black = vegdist(genes_fecal_filtered_black[,2:42254], method = "bray")
jaccf_gene_black = vegdist(genes_fecal_filtered_black[,2:42254], method = "jaccard")
brayf_gene_white = vegdist(genes_fecal_filtered_white[,2:42254], method = "bray")
jaccf_gene_white = vegdist(genes_fecal_filtered_white[,2:42254], method = "jaccard")
...
brayo_gene_black = vegdist(genes_oral_filtered_black[,2:33457], method = "bray")
jacco_gene_black = vegdist(genes_oral_filtered_black[,2:33457], method = "jaccard")
brayo_gene_white = vegdist(genes_oral_filtered_white[,2:33457], method = "bray")
jacco_gene_white = vegdist(genes_oral_filtered_white[,2:33457], method = "jaccard")
```
...
adonis2(brayf_gene ~ Ethnicity + `Study period` + `Antibiotic use` + `Contraceptive use` + subject_id, data = genes_fecal_filtered, 
        permutations = 4999)
adonis2(brayf_gene ~ `Study period`, data = genes_fecal_filtered, 
        permutations = 4999)
adonis2(brayf_gene_black ~ `Study period`, data = genes_fecal_filtered_black, 
        permutations = 4999)
adonis2(brayf_gene_white ~ `Study period`, data = genes_fecal_filtered_white, 
        permutations = 4999)
```
...
adonis2(brayo_gene ~ Ethnicity + `Study period` + `Antibiotic use` + `Contraceptive use` + subject_id, data = genes_oral_filtered, 
        permutations = 4999)
adonis2(brayo_gene ~ `Study period`, data = genes_oral_filtered, 
        permutations = 4999)
adonis2(brayo_gene_black ~ `Study period`, data = genes_oral_filtered_black, 
        permutations = 4999)
adonis2(brayo_gene_white ~ `Study period`, data = genes_oral_filtered_white, 
        permutations = 4999)
```
...
brayfgy1 <- ggplot(mds_bray_f_gene_points2, aes(x = MDS1, y = MDS2, 
                                                 color = Ethnicity)) +
  ...
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "<b><i>p</i> < 0.001, r<sup>2</sup> = 5.9% (All)<br><i>p</i> = 0.008, r<sup>2</sup> = 6.8% (Before)<br><i>p</i> < 0.001, r<sup>2</sup> = 6.8% (During)<br><i>p</i> = 0.014, r<sup>2</sup> = 6.3% (After)</b><br>", 
           x = Inf, y = Inf, size = 4,
           hjust = 1.1, vjust = 1.1)  +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "Stress = 0.151",
...
mds_bray_o_gene_points2<-merge(x=mds_bray_o_gene_points, 
                               y = genes_oral_filtered, 
                                  by.x = "row.names", by.y = "row.names")
brayogy1 <- ggplot(mds_bray_o_gene_points2, aes(x = MDS1, y = MDS2, 
                                                 color = Ethnicity)) +
  geom_point(size=3) + scale_color_manual(
    values = c("White"="#87ceeb","Black"="#f5c4ca")) +
  theme(panel.background = element_rect(fill = 'white', colour = 'black'), 
  ...
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "<b><i>p</i> < 0.001, r<sup>2</sup> = 11.2% (All)<br><i>p</i> = 0.002, r<sup>2</sup> = 15.1% (Before)</b><br><i>p</i> = 0.098, r<sup>2</sup> = 8.6% (After)<br>", 
           x = Inf, y = Inf, size = 4,
           hjust = 1.1, vjust = 1.1)  +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "Stress = 0.107",
...
brayfgy1s <- ggplot(mds_bray_f_gene_points2, aes(x = MDS1, y = MDS2, 
                                                 color = `Study period`)) +
  geom_point(size=3) + scale_color_manual(
  ...
  stat_ellipse(data = mds_bray_f_gene_points2, aes(x = MDS1, y = MDS2, 
               ...
               type = "t", level = 0.95) +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "<i>p</i> = 0.999, r<sup>2</sup> = 0.9% (Both)<br><i>p</i> = 0.995, r<sup>2</sup> = 1.7% (Black)<br><i>p</i> = 0.996, r<sup>2</sup> = 1.7% (White)<br>", 
           x = Inf, y = Inf, size = 4,
           hjust = 1.1, vjust = 1.1)  +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "Stress = 0.151",
...
brayogy1s <- ggplot(mds_bray_o_gene_points2, aes(x = MDS1, y = MDS2, 
                                                 color = `Study period`)) +
  geom_point(size=3) + scale_color_manual(
  ...
  stat_ellipse(data = mds_bray_o_gene_points2, aes(x = MDS1, y = MDS2, 
               ...
               type = "t", level = 0.95) +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "<i>p</i> = 0.734, r<sup>2</sup> = 3.5% (Both)<br><i>p</i> = 0.860, r<sup>2</sup> = 1.8% (Black)<br><i>p</i> = 0.760, r<sup>2</sup> = 7.5% (White)<br>", 
           x = Inf, y = Inf, size = 4,
           hjust = 1.1, vjust = 1.1)  +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "Stress = 0.107",
...
tiff(file = "figures/nmds_plot_cog_bray_e_y1.tif", res = 150, width = 18, 
     height = 7, units = "in")
...
tiff(file = "figures/nmds_plot_cog_bray_s_y1.tif", res = 150, width = 18, 
     height = 7, units = "in")
...
adonis2(jaccf_gene ~ Ethnicity, data = genes_fecal_filtered, 
        permutations = 4999)
adonis2(jaccf_gene ~ `Study period`, data = genes_fecal_filtered, 
        permutations = 4999)
adonis2(jaccf_gene_black ~ `Study period`, data = genes_fecal_filtered_black, 
        permutations = 4999)
adonis2(jaccf_gene_white ~ `Study period`, data = genes_fecal_filtered_white, 
        permutations = 4999)
```

Oral
```{r permanova_jacco_gene}
adonis2(jacco_gene ~ Ethnicity, data = genes_oral_filtered, 
        permutations = 4999)
adonis2(jacco_gene ~ `Study period`, data = genes_oral_filtered, 
        permutations = 4999)
adonis2(jacco_gene_black ~ `Study period`, data = genes_oral_filtered_black, 
        permutations = 4999)
adonis2(jacco_gene_white ~ `Study period`, data = genes_oral_filtered_white, 
        permutations = 4999)
```
...
jaccfg <- ggplot(mds_jacc_f_gene_points2, aes(x = MDS1, y = MDS2, 
  ...
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "<b><i>p</i> < 0.001, r<sup>2</sup> = 5.2% (All)<br><i>p</i> = 0.008, r<sup>2</sup> = 6.1% (Before)<br><i>p</i> < 0.001, r<sup>2</sup> = 6.1% (During)<br><i>p</i> = 0.002, r<sup>2</sup> = 6.4% (After)</b><br>", 
           x = Inf, y = Inf, size = 4,
           hjust = 1.1, vjust = 1.1)  +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "Stress = 0.151",
...
jaccog <- ggplot(mds_jacc_o_gene_points2, aes(x = MDS1, y = MDS2, 
  ...
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "<b><i>p</i> < 0.001, r<sup>2</sup> = 9.8% (All)<br><i>p</i> = 0.003, r<sup>2</sup> = 13.1% (Before)</b><br><i>p</i> = 0.103, r<sup>2</sup> = 8.3% (After)<br>", 
           x = Inf, y = Inf, size = 4,
           hjust = 1.1, vjust = 1.1)  +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "Stress = 0.111",
...
jaccfgs <- ggplot(mds_jacc_f_gene_points2, aes(x = MDS1, y = MDS2, 
  ...
  ggtitle("COGs - Jaccard - Fecal")  +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "<i>p</i> = 0.999, r<sup>2</sup> = 1.0% (Both)<br><i>p</i> = 0.996, r<sup>2</sup> = 2.0% (Black)<br><i>p</i> = 0.998, r<sup>2</sup> = 1.9% (White)<br>", 
           x = Inf, y = Inf, size = 4,
           hjust = 1.1, vjust = 1.1)  +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "Stress = 0.151",
...
jaccogs <- ggplot(mds_jacc_o_gene_points2, aes(x = MDS1, y = MDS2, 
  ...
  ggtitle("COGs - Jaccard - Oral")  +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "<i>p</i> = 0.997, r<sup>2</sup> = 0.9% (Both)<br><i>p</i> = 0.851, r<sup>2</sup> = 2.3% (Black)<br><i>p</i> = 0.961, r<sup>2</sup> = 3.0% (White)<br>", 
           x = Inf, y = Inf, size = 4,
           hjust = 1.1, vjust = 1.1)  +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "Stress = 0.111",
...
tiff(file = "figures/nmds_plot_cog_jacc_e_y1.tif", res = 150, width = 18, 
     height = 7, units = "in")
...
tiff(file = "figures/nmds_plot_cog_jacc_s_y1.tif", res = 150, width = 18, 
     height = 7, units = "in")
...
brayf_gene_b = vegdist(gene_fecal_before[,2:42254], method = "bray")
jaccf_gene_b = vegdist(gene_fecal_before[,2:42254], method = "jaccard")
brayo_gene_b = vegdist(gene_oral_before[,2:33457], method = "bray")
jacco_gene_b = vegdist(gene_oral_before[,2:33457], method = "jaccard")
```
#### Bray-Curtis - Before
Fecal
...
tiff(file = "figures/nmds_plot_cog_bray_before_y1.tif", 
...
tiff(file = "figures/nmds_plot_cog_jacc_before_y1.tif", 
     res = 150, width = 18, height = 7, units = "in")
...
brayf_gene_d = vegdist(gene_fecal_during[,2:42254], method = "bray")
jaccf_gene_d = vegdist(gene_fecal_during[,2:42254], method = "jaccard")
```
#### Bray-Curtis - During
Fecal
...
tiff(file = "figures/nmds_plot_cog_bray_during_y1.tif", 
...
tiff(file = "figures/nmds_plot_cog_jacc_during_y1.tif", 
     res = 150, width = 9, height = 7, units = "in")
jaccfgd
dev.off()
```
...
brayf_gene_a = vegdist(gene_fecal_after[,2:42254], method = "bray")
jaccf_gene_a = vegdist(gene_fecal_after[,2:42254], method = "jaccard")
brayo_gene_a = vegdist(gene_oral_after[,2:33457], method = "bray")
jacco_gene_a = vegdist(gene_oral_after[,2:33457], method = "jaccard")
```
#### Bray-Curtis - After
Fecal
...
tiff(file = "figures/nmds_plot_cog_bray_after_y1.tif", 
     res = 150, width = 18, height = 7, units = "in")
...
tiff(file = "figures/nmds_plot_cog_jacc_after_y1.tif", 
     res = 150, width = 18, height = 7, units = "in")
...
metadata_args = read_tsv("year1_sample_mapping_args_noout.tsv") %>% 
  mutate(Ethnicity = case_when(Ethnicity == "African_American" ~ "Black", 
                               Ethnicity == "Caucasian" ~ "White"))
```
...
arg_table = read_tsv("all_shortbred_abundance_year1.tsv")
args = arg_table %>% gather(file, count, 2:193) %>% 
  spread(Family, count)
```
...
args_fecal_filtered = args_fecal %>% 
  ...
  filter(total > 0) %>% 
  select_if(~ !is.numeric(.) || sum(.) != 0) 
write_csv(args_fecal_filtered, "arg_fecal_year1.csv")
args_fecal_filtered = read_csv("arg_fecal_year1.csv")
...
args_oral_filtered = args_oral %>% 
  ...
  filter(total > 0) %>% 
  select_if(~ !is.numeric(.) || sum(.) != 0) 
write_csv(args_oral, "arg_oral_year1.csv")
args_oral_filtered = read_csv("arg_oral_year1.csv")
```

### Calculating beta diversity metrics
Vegan (2.5-7) is used to calculate the Bray-Curtis dissimilarity and Jaccard similarity metrics.
```{r beta_metrics_arg, error=FALSE}
brayf_arg = vegdist(args_fecal_filtered[,2:185], method = "bray")
brayo_arg = vegdist(args_oral_filtered[,2:86], method = "bray")
jaccf_arg = vegdist(args_fecal_filtered[,2:185], method = "jaccard")
jacco_arg = vegdist(args_oral_filtered[,2:86], method = "jaccard")
```

PERMANOVAs to examine effect of ethnicity, dietary stage, antibiotic use, contraceptive use, and individual identity on ARG profiles
```{r perm_arg}
...
mds_bray_f_arg_points2<-merge(x=mds_bray_f_arg_points, 
                               y = args_fecal_filtered, 
                                  by.x = "row.names", by.y = "row.names")
brayfargy1 <- ggplot(mds_bray_f_arg_points2, aes(x = MDS1, y = MDS2, 
                                                 color = Ethnicity)) +
  geom_point(size=3) + scale_color_manual(
    values = c("White"="#87ceeb","Black"="#f5c4ca")) +
  theme(panel.background = element_rect(fill = 'white', colour = 'black'), 
...
mds_bray_o_arg_points2<-merge(x=mds_bray_o_arg_points, 
                               y = args_oral_filtered, 
                                  by.x = "row.names", by.y = "row.names")
brayoargy1 <- ggplot(mds_bray_o_arg_points2, aes(x = MDS1, y = MDS2, 
                                                 color = Ethnicity)) +
  geom_point(size=3) + scale_color_manual(
    values = c("White"="#87ceeb","Black"="#f5c4ca")) +
  theme(panel.background = element_rect(fill = 'white', colour = 'black'), 
...
brayfargy1s <- ggplot(mds_bray_f_arg_points2, aes(x = MDS1, y = MDS2, 
                                                 color = `Study period`)) +
  geom_point(size=3) + scale_color_manual(
    values = c("Before"="#238b45","During" = "#d94801", "After"="#2171b5")) + scale_fill_manual(
    values = c("Before"="#238b45","During" = "#d94801", "After"="#2171b5")) +
  ...
  stat_ellipse(data = mds_bray_f_arg_points2, aes(x = MDS1, y = MDS2, 
               ...
               type = "t", level = 0.95) +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "<i>p</i> = 0.997, r<sup>2</sup> = 0.6% (Both)<br><i>p</i> = 0.904, r<sup>2</sup> = 2.4% (Black)<br><i>p</i> = 0.977, r<sup>2</sup> = 1.5% (White)<br>", 
           x = Inf, y = Inf, size = 4,
           hjust = 1.1, vjust = 1.1)  +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "Stress = 0.192",
...
brayoargy1s <- ggplot(mds_bray_o_arg_points2, aes(x = MDS1, y = MDS2, 
                                                 color = `Study period`)) +
  geom_point(size=3) + scale_color_manual(
    values = c("Before"="#238b45","After"="#2171b5")) + 
  scale_fill_manual(values = c("Before"="#238b45","After"="#2171b5")) +
  ...
  stat_ellipse(data = mds_bray_o_arg_points2, aes(x = MDS1, y = MDS2, 
               ...
               type = "t", level = 0.95) +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "<i>p</i> = 0.997, r<sup>2</sup> = 0.3% (Both)<br><i>p</i> = 0.994, r<sup>2</sup> = 0.4% (Black)<br><i>p</i> = 0.898, r<sup>2</sup> = 2.4% (White)<br>", 
           x = Inf, y = Inf, size = 4,
           hjust = 1.1, vjust = 1.1)  +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "Stress = 0.124",
...
## Combo graph for supplement

```{r nmds_save_bray_combo}
tiff(file = "figures/nmds_plot_all.tif", res = 300, width = 30, 
     height = 30, units = "in")
legend1 = get_legend(brayfsy1 + theme(legend.box.margin = margin(0, 0, 0, 12)))
legend2 = get_legend(brayosy1 + theme(legend.box.margin = margin(0, 0, 0, 12)))
col1 = plot_grid(brayfsy1 + theme(legend.position = "none"),
                 brayosy1 + theme(legend.position = "none"),
                 brayfsy2 + theme(legend.position = "none"),
                 brayosy2 + theme(legend.position = "none"),
                 nrow = 4, ncol = 1, labels = c("A","D","G","J"), 
                 label_size = 20)
col2 = plot_grid(brayfgy1s + theme(legend.position = "none"),
                 brayogy1s + theme(legend.position = "none"),
                 brayfgy2s + theme(legend.position = "none"),
                 brayogy2s + theme(legend.position = "none"),
                 nrow = 4, ncol = 1, labels = c("B","E","H","K"), 
                 label_size = 20) 
col3 = plot_grid(brayfargy1s + theme(legend.position = "none"),
                 brayoargy1s + theme(legend.position = "none"),
                 brayfargy2s + theme(legend.position = "none"),
                 brayoargy2s + theme(legend.position = "none"),
                 nrow = 4, ncol = 1, labels = c("C","F","I","L"), 
                 label_size = 20) 
col4 = plot_grid(legend1, legend2, nrow = 2, ncol =1, labels = c(""))
