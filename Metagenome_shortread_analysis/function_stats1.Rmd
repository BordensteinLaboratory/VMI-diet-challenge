...
adonis2(brayf_gene ~ Ethnicity, data = genes_fecal_filtered, 
        permutations = 4999)
...
adonis2(brayo_gene ~ Ethnicity, data = genes_oral_filtered, 
        permutations = 4999)
...
brayfgs <- ggplot(mds_bray_f_gene_points2, aes(x = MDS1, y = MDS2, 
                                                 color = `Study period`)) +
  geom_point(size=3) + scale_color_manual(
...
brayogs <- ggplot(mds_bray_o_gene_points2, aes(x = MDS1, y = MDS2, 
                                                 color = `Study period`)) +
  geom_point(size=3) + scale_color_manual(
