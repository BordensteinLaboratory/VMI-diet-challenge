...
adonis2(brayf_gene ~ Ethnicity + `Study period` + `Antibiotic use` + `Contraceptive use`, data = genes_fecal_filtered, 
        permutations = 4999)
...
adonis2(brayo_gene ~ Ethnicity + `Study period` + `Antibiotic use` + `Contraceptive use`, data = genes_oral_filtered, 
        permutations = 4999)
