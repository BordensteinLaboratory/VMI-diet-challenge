...
brayfy1 <- ggplot(mds_bray_f_points2y1, aes(x = MDS1, y = MDS2, 
  ...
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "<b><i>p</i> < 0.001, r<sup>2</sup> = 6.6%</b>", 
           x = Inf, y = Inf, size = 4,
           hjust = 1.1, vjust = 1.1)  +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "Stress = 0.170",
...
brayoy1 <- ggplot(mds_bray_o_points2y1, aes(x = MDS1, y = MDS2, 
  ...
  stat_ellipse(data = mds_bray_o_points2y1, aes(x = MDS1, y = MDS2, 
               ...
               type = "t", level = 0.95) + 
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "<b><i>p</i> < 0.001, r<sup>2</sup> = 12.7%</b>", 
           x = Inf, y = Inf, size = 4,
           hjust = 1.1, vjust = 1.1)  +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "Stress = 0.158",
...
brayfsy1 <- ggplot(mds_bray_f_points2y1, aes(x = MDS1, y = MDS2, 
  ...
  stat_ellipse(data = mds_bray_f_points2y1, aes(x = MDS1, y = MDS2, 
               ...
               type = "t", level = 0.95) + 
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "<b><i>p</i> < 0.001, r<sup>2</sup> = 0.9%</b>", 
           x = Inf, y = Inf, size = 4,
           hjust = 1.1, vjust = 1.1)  +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "Stress = 0.170",
...
brayosy1 <- ggplot(mds_bray_o_points2y1, aes(x = MDS1, y = MDS2, 
  ...
  stat_ellipse(data = mds_bray_o_points2y1, aes(x = MDS1, y = MDS2, 
               ...
               type = "t", level = 0.95) + 
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "<i>p</i> = 0.328, r<sup>2</sup> = 0.8%", 
           x = Inf, y = Inf, size = 4,
           hjust = 1.1, vjust = 1.1)  +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "Stress = 0.158",
...
brayfy2 <- ggplot(mds_bray_f_points2y2, aes(x = MDS1, y = MDS2, 
  ...
  stat_ellipse(data = mds_bray_f_points2y2, aes(x = MDS1, y = MDS2, 
               ...
               type = "t", level = 0.95) + 
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "<b><i>p</i> < 0.001, r<sup>2</sup> = 8.2%</b>", 
           x = Inf, y = Inf, size = 4,
           hjust = 1.1, vjust = 1.1)  +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "Stress = 0.170",
...
brayoy2 <- ggplot(mds_bray_o_points2y2, aes(x = MDS1, y = MDS2, 
  ...
  stat_ellipse(data = mds_bray_o_points2y2, aes(x = MDS1, y = MDS2, 
               ...
               type = "t", level = 0.95) + 
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "<b><i>p</i> < 0.001, r<sup>2</sup> = 8.4%</b>", 
           x = Inf, y = Inf, size = 4,
           hjust = 1.1, vjust = 1.1)  +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "Stress = 0.158",
...
brayfsy2 <- ggplot(mds_bray_f_points2y2, aes(x = MDS1, y = MDS2, 
  ...
  stat_ellipse(data = mds_bray_f_points2y2, aes(x = MDS1, y = MDS2, 
               ...
               type = "t", level = 0.95) + 
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "<b><i>p</i> < 0.001, r<sup>2</sup> = 0.8%</b>", 
           x = Inf, y = Inf, size = 4,
           hjust = 1.1, vjust = 1.1)  +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "Stress = 0.170",
...
brayosy2 <- ggplot(mds_bray_o_points2y2, aes(x = MDS1, y = MDS2, 
  ...
  stat_ellipse(data = mds_bray_o_points2y2, aes(x = MDS1, y = MDS2, 
               ...
               type = "t", level = 0.95) + 
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "<i>p</i> = 0.407, r<sup>2</sup> = 0.9%", 
           x = Inf, y = Inf, size = 4,
           hjust = 1.1, vjust = 1.1)  +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "Stress = 0.158",
