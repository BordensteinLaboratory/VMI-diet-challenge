...
brayf <- ggplot(mds_bray_f_points2, aes(x = MDS1, y = MDS2, 
  ...
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "<b><i>p</i> < 0.001, r<sup>2</sup> = 6.6% (All)</b><br><i>p</i> = 0.217, r<sup>2</sup> = 8.0% (Before)<br><b><i>p</i> < 0.001, r<sup>2</sup> = 6.7% (During)</b><br><b><i>p</i> = 0.022, r<sup>2</sup> = 7.8% (After)</b><br>", 
           x = Inf, y = Inf, size = 4,
           hjust = 1.1, vjust = 1.1)  +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "Stress = 0.196",
...
brayo <- ggplot(mds_bray_o_points2, aes(x = MDS1, y = MDS2, 
  ...
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "<b><i>p</i> = 0.004, r<sup>2</sup> = 9.3% (All)</b><br><i>p</i> = 0.109, r<sup>2</sup> = 9.3% (Before)<br><b><i>p</i> = 0.019, r<sup>2</sup> = 14.8% (After)</b><br>", 
           x = Inf, y = Inf, size = 4,
           hjust = 1.1, vjust = 1.1)  +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "Stress = 0.169",
...
brayfs <- ggplot(mds_bray_f_points2, aes(x = MDS1, y = MDS2, 
                                                 color = `Study period`)) +
  geom_point(size=3) + scale_color_manual(
  ...
  ggtitle("Bray-Curtis - Fecal")  +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "<i>p</i> = 0.986, r<sup>2</sup> = 0.8% (Both)<br><i>p</i> = 0.995, r<sup>2</sup> = 1.2% (Black)<br><i>p</i> = 0.932, r<sup>2</sup> = 1.9% (White)<br>", 
           x = Inf, y = Inf, size = 4,
           hjust = 1.1, vjust = 1.1)  +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "Stress = 0.196",
...
brayos <- ggplot(mds_bray_o_points2, aes(x = MDS1, y = MDS2, 
                                                 color = `Study period`)) +
  geom_point(size=3) + scale_color_manual(
  ...
  ggtitle("Bray-Curtis - Oral")  +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "<i>p</i> = 0.990, r<sup>2</sup> = 0.9% (Both)<br><i>p</i> = 0.946, r<sup>2</sup> = 2.1% (Black)<br><i>p</i> = 0.701, r<sup>2</sup> = 5.5% (White)<br>", 
           x = Inf, y = Inf, size = 4,
           hjust = 1.1, vjust = 1.1)  +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "Stress = 0.169",
