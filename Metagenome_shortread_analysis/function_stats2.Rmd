...
genes_fecal_filtered = read_csv("gene_family_cog_cpm_fecal.csv")
...
genes_oral_filtered = read_csv("gene_family_cog_cpm_oral.csv")
```
...
jaccf_gene = vegdist(genes_fecal_filtered[,2:40168], method = "jaccard")
brayo_gene = vegdist(genes_oral_filtered[,2:32391], method = "bray")
jacco_gene = vegdist(genes_oral_filtered[,2:32391], method = "jaccard")
...
jaccf_gene_black = vegdist(genes_fecal_filtered_black[,2:40168], method = "jaccard")
brayf_gene_white = vegdist(genes_fecal_filtered_white[,2:40168], method = "bray")
jaccf_gene_white = vegdist(genes_fecal_filtered_white[,2:40168], method = "jaccard")
...
jacco_gene_black = vegdist(genes_oral_filtered_black[,2:32391], method = "jaccard")
brayo_gene_white = vegdist(genes_oral_filtered_white[,2:32391], method = "bray")
jacco_gene_white = vegdist(genes_oral_filtered_white[,2:32391], method = "jaccard")
```
...
metadata_args = read_tsv("year2_sample_mapping_args_noout.tsv") %>% 
  mutate(Ethnicity = case_when(Ethnicity == "African_American" ~ "Black", 
                               Ethnicity == "Caucasian" ~ "White"))
```
...
args_fecal_filtered = read_csv("arg_fecal_year2.csv")
...
args_oral_filtered = read_csv("arg_oral_year2.csv")
```
...
adonis2(brayf_arg ~ Ethnicity + `Study period` + `Antibiotic use` + `Contraceptive use`, data = args_fecal_filtered, 
        permutations = 4999)
adonis2(brayf_arg ~ `Study period`, data = args_fecal_filtered, 
        permutations = 4999)
adonis2(brayf_arg_black ~ `Study period`, data = args_fecal_filtered_black, 
        permutations = 4999)
adonis2(brayf_arg_white ~ `Study period`, data = args_fecal_filtered_white, 
        permutations = 4999)
```

```{r permanova_brayo_arg}
adonis2(brayo_arg ~ Ethnicity + `Study period` + `Antibiotic use` + `Contraceptive use`, data = args_oral_filtered, 
        permutations = 4999)
adonis2(brayo_arg ~ `Study period`, data = args_oral_filtered, 
        permutations = 4999)
adonis2(brayo_arg_black ~ `Study period`, 
        data = args_oral_filtered_black, 
        permutations = 4999)
adonis2(brayo_arg_white ~ `Study period`, 
        data = args_oral_filtered_white, 
        permutations = 4999)
```
